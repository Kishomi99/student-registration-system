        ...
        <div class="px-4 py-4 w-full">
            ...
            <form action="{{ route('students.store') }}" method="POST">
                ...
                <div class="flex items-center justify-between h-14 w-full mb-2">
                    ...
                    <div>
                        <input type="text" name="stu_name"
                            class="rounded-md h-10 w-96 border mt-2 p-2 @error('stu_name') border-red-500 @enderror"
                            placeholder="Enter your Name" value="{{ old('stu_name') }}" />
                        @error('stu_name')
                ...
                <div class=" flex items-center justify-between h-14 w-full mb-2">
                    ...
                    <div>
                        <input type="email" name="email"
                            class=" rounded-md h-10 w-96 border  mt-2 p-2 @error('email') border-red-500 @enderror"
                ...
                <div class="flex items-center justify-between h-14 w-full mb-2">
                    ...
                    <div>
                        <input type="text" name="phone_no"
                            class=" rounded-md h-10 w-96 border  mt-2 p-2 @error('phone_no') border-red-500 @enderror"
                    ...
                    <div>
                        <div class='w-96 space-x-10 rounded-md h-10 border  mt-2 p-2 bg-white'>
                            <label class=" text-gray-600 text-base font-semibold">
                                ...
                                <input type="radio" type="radio" name="gender" value="male"
                                    class=" @error('gender') border-red-500 @enderror" />
                        ...
                        @error('gender')
                            <p class="text-red-500 text-sm mt-1 font-normal ">{{ $message }}</p>
                        @enderror
                    </div>
                </div>
                <div class="flex items-center justify-between h-14 w-full mb-4">
                    ...
                    <div>
                        <input type="date" name="dob"
                            class="rounded-md h-10 w-96 border  mt-2 p-2
                ...
                <div class="flex items-center justify-between h-14 w-full mb-2">
                    ...
                    <div>
                        <textarea name="address" class="rounded-md  w-96 border  mt-5 p-2 @error('address') border-red-500 @enderror">{{ old('address') }} </textarea>
                        @error('address')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
